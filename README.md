...
```
assure-main/
├── pom.xml                          # Maven build (project root)
├── src/main/java/.../assure/        # Spring Boot backend
...
│   └── modelmapper/                 # Mapping config
├── src/main/resources/              # application.properties, data.sql
├── src/test/java/                   # Tests
└── frontend/                        # HTML, CSS, JS, images, icons
```
...
The API starts on port **8070**. Open `frontend/html/login.html` in a browser after the server is up.
