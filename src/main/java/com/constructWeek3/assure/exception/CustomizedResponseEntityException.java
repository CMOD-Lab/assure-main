...
public class CustomizedResponseEntityException extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleUserExistException(Exception e, WebRequest webRequest){
    ...
    public final ResponseEntity<Object> handleIncorrectOTPException(Exception e, WebRequest webRequest){
    ...
    public final ResponseEntity<Object> handleEmptyOTPException(Exception e, WebRequest webRequest){
    ...
    public final ResponseEntity<Object> handleIncorrectPasswordAndEmailException(Exception e, WebRequest webRequest){
